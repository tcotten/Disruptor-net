...
{
    public IEnumerable<IncomingTodoList> TodoLists = default!;
    public IEnumerable<IncomingLineItem> LineItems = default!;
}

public class TodoList : BaseTodoList
{
    public TodoList() { LineItems = Enumerable.Empty<LineItem>(); }
    ...
    public static TodoList Merge(IEnumerable<TodoList> lists)
    {
        ...
        if (newest == null) { return new TodoList(); }
