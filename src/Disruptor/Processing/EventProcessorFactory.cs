...
public static class EventProcessorFactory
{
        ...
        where T : class
    {
        ...
        var eventProcessorType = processorType.MakeGenericType(typeof(T), dataProviderProxy.GetType(), eventHandlerProxy.GetType(), onBatchStartInvoker.GetType());
        ...
        where T : class
    {
        ...
        var eventProcessorType = processorType.MakeGenericType(typeof(T), dataProviderProxy.GetType(), eventHandlerProxy.GetType());
        ...
        where T : class
    {
        ...
        var eventProcessorType = typeof(AsyncBatchEventProcessor<,,>).MakeGenericType(typeof(T), dataProviderProxy.GetType(), eventHandlerProxy.GetType());
